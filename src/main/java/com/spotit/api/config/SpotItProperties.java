 ...
 * stored in the DB (SMTP password, JWT signing secret — see {@code ConfigurationDomainService}),
 * so it can never live in the DB itself. Everything else that used to be config here now lives in
 * the {@code global_configuration} table.
 */
