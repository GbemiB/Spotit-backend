...
public final class PropertyNames {
    ...
    // tables (badge_config/challenge_config/level_config); these constants survive only so
    // ConfigStoreMigration can find and copy any such rows off an already-deployed database.
